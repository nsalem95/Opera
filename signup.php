...
<html lang="en">
  ...
  <input name="Username" style="display: inline-block; width: 40%;" class="form-control" type="text" placeholder="Username" id="Username" value="<?php echo $_POST['username'];?>">
    <input name="Password" style="display: inline-block; width: 40%; margin-left: 10%;" class="form-control" placeholder="Password" type="password" id="Password" value="<?php echo $_POST['password'];?>">
...
<div class="form-group row" style="margin-left: 0.3%; margin-right: 2%;">
  ...
  <div class="">
    <input name="Email" class="form-control" type="email" placeholder="Enter Email" id="Email" value="<?php echo $_POST['email'];?>">
  </div>
